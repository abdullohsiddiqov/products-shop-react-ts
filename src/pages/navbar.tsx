                    ...
                    {user ? (
                        <>
                            <div className="user-info">
                                ...
                                <span style={{ color: "black" }} className='user'>{user.name}</span>
                            </div>
                ...
                <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        <div className={activeSlide === 0 ? "carousel-item active" : "carousel-item"}>
                            <img src={colorIcon} className="d-block w-100" alt="Colorful Icon"/>
                        ...
                        <div className={activeSlide === 1 ? "carousel-item active" : "carousel-item"}>
                            <img src={clothesIcon} className="d-block w-100" alt="Clothes Icon"/>
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className={activeSlide === 2 ? "carousel-item active" : "carousel-item"}>
                            <img src={recycleIcon} className="d-block w-100" alt="Recycle Icon"/>
                            <div className="carousel-caption d-none d-md-block">
